...
public class SearchWidget extends LinearLayout {
    ...
    public SearchWidget(final Context context, AttributeSet attrs) {
        ...
        //将自定义的属性值设置到组件上
        mAutoCompleteTextView.setText(mSearchHint);
    ...
    private SearchWidget.OnIconClickListener listener;

    //第二步， 写一个公共的方法
    public void setOnIconClickListener(SearchWidget.OnIconClickListener listener) {
